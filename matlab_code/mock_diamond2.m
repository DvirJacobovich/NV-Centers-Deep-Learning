...
%         num_pts = 180; % number of frequency points in simulation
    ...
    methods
        ...
        obj.B_theta = (22 - 18).*rand(1,1) + 18; % was B_phi = 70;
        obj.B_phi = (71 - 69).*rand(1,1) + 69; % was B_theta = 20;
        obj.B_mag = randi([90 110]); % was B_mag 100 [Gauss]
            if ~isempty(varargin)
                ...
                obj.smp_freqs = obj.center_freq+...
                    linspace(-(0.5*full_peak_window+pad_width), (0.5*full_peak_window+pad_width), 200);
